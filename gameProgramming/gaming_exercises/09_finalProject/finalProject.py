...
def game_over_screen():
    screen.fill(WHITE)
    show_text_on_screen("Aw shucks you're out of lives", 50, HEIGHT // 3)
    show_text_on_screen(f"Your final score was: {score}", 30, HEIGHT // 2)
...
def victory_screen():
    screen.fill(WHITE)
    show_text_on_screen("Congrats!", 50, HEIGHT // 3)
    show_text_on_screen(f"Winner winner chicken dinner! Your score was {score}", 30, HEIGHT // 2)
